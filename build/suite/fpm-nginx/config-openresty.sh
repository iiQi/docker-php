...
curl -o /etc/openresty/conf.d/default.conf https://raw.githubusercontent.com/iiQi/docker-openresty/main/rootfs/usr/local/openresty/nginx/conf/conf.d/default.conf
